...
//		int disCenterX = displayWidth / 2;
		...
		String sneak=I18n.format("display.label.sneak"), sprint=I18n.format("display.label.sprint");
		int textWidth = Math.max(mc.fontRenderer.getStringWidth(sprint), mc.fontRenderer.getStringWidth(sneak));
		
		drawRect(2, disCenterY - 1 - mc.fontRenderer.FONT_HEIGHT - 2, 4 + textWidth + 4, disCenterY - 1,
				toggleSneak?colorPack(0,0,196,196):colorPack(196,196,196,64));	    	
		drawString(mc.fontRenderer, sneak, 4, disCenterY - 2 - mc.fontRenderer.FONT_HEIGHT,
				mim.sneak?colorPack(255,255,0,96):colorPack(64,64,64,128));
		drawRect(2, disCenterY + 1, 4 + textWidth + 4, disCenterY + 1 + mc.fontRenderer.FONT_HEIGHT + 2,
				toggleSprint?colorPack(0,0,196,196):colorPack(196,196,196,64));	    	
		drawString(mc.fontRenderer, sprint, 4, disCenterY + 2,
