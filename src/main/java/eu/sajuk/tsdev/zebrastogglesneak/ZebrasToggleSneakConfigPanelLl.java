...
public class ZebrasToggleSneakConfigPanelLl extends Gui implements ConfigPanel {
	...
	public void mousePressed(ConfigPanelHost host, int mouseX, int mouseY, int mouseButton) {
		if (sneakFunctionEnabled.mousePressed(mc, mouseX, mouseY)) {
			...
			sneakFunctionEnabled.func_146113_a(mc.getSoundHandler());
			...
			sprintFunctionEnabled.func_146113_a(mc.getSoundHandler());
			...
			statusDisplayEnabled.func_146113_a(mc.getSoundHandler());
	...
	public void mouseReleased(ConfigPanelHost host, int mouseX, int mouseY, int mouseButton) {
		if (activeButton != null) {
			activeButton.func_146111_b(mouseX, mouseY); /* whatever this does, is noop currently */
			activeButton = null;
		}
	}
